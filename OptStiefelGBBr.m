function [X, out]= OptStiefelGBBr(X, fun, opts, varargin)
%-------------------------------------------------------------------------
% curvilinear search algorithm for optimization on Stiefel manifold revised 
% with simple stopping criterion
%
