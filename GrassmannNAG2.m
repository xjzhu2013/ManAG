function [X, out] = GrassmannNAG2(fun, X0, opts, varargin)
% Retraction-based Nesterov accelerated gradient method on Grassmann manifold
% Input: fun - objective 
%        X0 - initial point
